class SunOrb{constructor(e){this.container=document.getElementById(e),this.container&&"undefined"!=typeof THREE&&(this.scene=new THREE.Scene,this.camera=new THREE.PerspectiveCamera(75,this.container.offsetWidth/this.container.offsetHeight,.1,1e3),this.renderer=new THREE.WebGLRenderer({antialias:!0,alpha:!0}),this.renderer.setClearColor(0,0),this.renderer.setSize(this.container.offsetWidth,this.container.offsetHeight),this.container.appendChild(this.renderer.domElement),this.createSun(),this.addLighting(),this.updateCamera(this.container.offsetWidth,this.container.offsetHeight),this.setupResizeHandler(),this.animate())}createSun(){var e=new THREE.SphereGeometry(1,64,64),t=new THREE.ShaderMaterial({uniforms:{time:{value:0}},vertexShader:`
        ...
        `;var e=document.createElement("div");e.textContent="Scroll Settings",e.style.cssText=`
            ...
            padding-bottom: 10px;
        `,a.appendChild(e);[{name:"arrowStep",label:"Arrow Step",min:10,max:500,step:10},{name:"easing",label:"Easing",min:.01,max:.5,step:.01},{name:"velocityFriction",label:"Velocity Friction",min:.7,max:.99,step:.01},{name:"scrollOffset",label:"Touch Offset",min:.1,max:2,step:.1},{name:"tapThreshold",label:"Tap Threshold (px)",min:5,max:50,step:5},{name:"tapTimeThreshold",label:"Tap Time (ms)",min:100,max:1e3,step:50}].forEach(t=>{var e=document.createElement("div"),i=(e.style.cssText="margin-bottom: 15px;",document.createElement("div")),o=(i.style.cssText="display: flex; justify-content: space-between; margin-bottom: 5px;",document.createElement("label"));o.textContent=t.label,o.style.cssText="color: #aaa;";let s=document.createElement("span");s.textContent=this[t.name],s.style.cssText="color: #0f0; font-weight: bold;",i.appendChild(o),i.appendChild(s);o=document.createElement("input");o.type="range",o.min=t.min,o.max=t.max,o.step=t.step,o.value=this[t.name],o.style.cssText="width: 100%; cursor: pointer;",o.addEventListener("input",e=>{e=parseFloat(e.target.value);this[t.name]=e,s.textContent=e}),e.appendChild(i),e.appendChild(o),a.appendChild(e)});let i=document.createElement("button"),t=(i.textContent="Hide",i.style.cssText=`
            width: 100%;
            padding: 8px;
            margin-top: 10px;
            background: #333;
            ...
            cursor: pointer;
            font-family: monospace;
        `,!1);a.querySelector("div").parentElement;i.addEventListener("click",()=>{(t=!t)?(Array.from(a.children).forEach((e,t)=>{0<t&&e!==i&&(e.style.display="none")}),i.textContent="Show",a.style.minWidth="120px"):(Array.from(a.children).forEach(e=>{e.style.display=""}),i.textContent="Hide",a.style.minWidth="280px")}),a.appendChild(i),document.body.appendChild(a),a.addEventListener("keydown",e=>{"ArrowUp"!==e.key&&"ArrowDown"!==e.key&&"ArrowLeft"!==e.key&&"ArrowRight"!==e.key&&" "!==e.key&&"Space"!==e.key||(e.preventDefault(),e.stopPropagation(),this.handleKeyScroll(e))}),document.addEventListener("keydown",e=>{"s"===e.key&&e.shiftKey&&e.metaKey&&(e.preventDefault(),a.style.display="none"===a.style.display?"":"none")})}async fetchLocalData(){try{var e=await fetch("https://us-central1-projects-342417.cloudfunctions.net/battery");if(!e.ok)throw new Error("Network response was not ok "+e.statusText);var t=await e.json();this.batteryLevel.textContent=`Battery: ${t.batteryLevel}%`,this.location.textContent="Location: "+t.location}catch(e){console.error("There was a problem with the fetch operation:",e),this.batteryLevel.innerHTML="",this.location.innerHTML=""}}}document.addEventListener("DOMContentLoaded",()=>{new SunOrb("header-sun"),new NightSky("footer-moon"),new App});